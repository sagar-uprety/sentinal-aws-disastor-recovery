...
import (
	...
	"aws-pilotlight-multi-region-dr/apps/sentry/internal/sentry"
...
func run() error {
	...
	mux.HandleFunc("GET /healthz", sentry.HandleHealthz(dataStore))
	mux.HandleFunc("GET /targets", sentry.HandleTargets(dataStore))
	mux.HandleFunc("GET /status", sentry.HandleStatus(dataStore))
	mux.HandleFunc("GET /history", sentry.HandleHistory(dataStore))
	mux.HandleFunc("GET /topology", sentry.HandleTopology(topologyService))
